...
def DHT22_Temp_Data_Handler(jsonData):
	...
	dbObj.add_del_update_db_record("insert into db_app_DHT22_Temperature_Data (SensorID, Date_n_Time, Temperature) values (?,?,?)", [
...
def DHT22_Humidity_Data_Handler(jsonData):
	...
	#Push into DB Table
	dbObj = DatabaseManager()
	dbObj.add_del_update_db_record("insert into db_app_DHT22_Humidity_Data (SensorID, Date_n_Time, Humidity) values (?,?,?)", [
